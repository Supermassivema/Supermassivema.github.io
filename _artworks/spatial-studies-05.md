...
The palette of grays, whites, and occasional color accents creates an urban sensibility while maintaining the work's abstract character. There's an architectural quality to the composition?�a sense of structure and order?�but also moments of spontaneity and gesture that humanize the geometric framework.

This piece exemplifies Jung Soo's ability to create works that are both visually compelling and intellectually engaging, bridging the gap between pure abstraction and architectural reference.
