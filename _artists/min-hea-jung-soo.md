...
philosophy: "Min Hea's practice centers on how photography and digital media function as interpretation and storytelling. By manipulating, layering, and recontextualizing images, they reveal the subjective nature of visual representation and the fluidity of identity."
featured: true
---

## Biography

Min Hea Jung Soo is a Korean artist working at the intersection of photography, digital media, and installation. Based in Inverell, Min Hea's practice explores the complexities of cultural identity, personal memory, and the ways we construct and reconstruct narratives about ourselves and our communities.
...
- *Work (1)* (Installation View)
- *Identity Study* (Digital Print)
- *Memory Layer* (Photography)
